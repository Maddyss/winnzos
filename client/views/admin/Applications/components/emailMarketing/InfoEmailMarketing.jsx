...
class InfoMarketing extends UserReactiveComponent {
    static propTypes = {
        info: PropTypes.bool,
    }
    static defaultProps = {
    ...
    render() {
        return (
            <div className="portfolio-content">
                <div className="cbp-l-project-title">Campagne Email</div>
                ...
                <div className="cbp-slider">
                    <ul className="cbp-slider-wrap">
                        <li className="cbp-slider-item">
                            <img src="/front/Email.png" alt="Campagne Email"/>
                        </li>
                    </ul>
                </div>
                <div className="cbp-l-project-container">
                    ...
                    <div className="cbp-l-project-details">
                        ...
                        <ul className="cbp-l-project-details-list">
                            <li>
                                <strong>Prduit</strong>Campagne Email</li>
                            <li>
